...
<body>
	...
	<div id="reg">
		...
		<form:form action="registration-success" method="get"
			...
			<table>
				...
				<tr>
					<table id="cbTable">
						<tr>
							...
							<td class="cb">Cricket:<br> <form:checkbox path="hobby"
									value="cricket" />
							<td>
							<td class="cb">Programming:<br> <form:checkbox
									path="hobby" value="programming" />
							<td>
							<td class="cb">Motorcycles:<br> <form:checkbox
									path="hobby" value="motorcycle" />
							<td>
							<td class="cb">Reading:<br> <form:checkbox path="hobby"
									value="reading" />
							<td>
						</tr>
					</table>
				...
				<tr>
					...
					<td>Male<form:radiobutton path="gender" value="male" />
						&nbsp;&nbsp;Female<form:radiobutton path="gender" value="female" /><br><br><br>
					</td>
				</tr>
				<tr>
					<td class="">&nbsp;&nbsp;&nbsp;&nbsp;<label>Age&nbsp;&nbsp;&nbsp;&nbsp;</label></td>
					<td>
						<form:input path="age"  />
			...
			<div style="border: none; margin-top: 20px; position: absolute; padding-left: 17px;">
				<h4>Communication</h4>
				<p>
					<label style="padding: 15px;">Email</label>
					<form:input path="userCommDTO.email" />
				</p>
				<p>
					<label style="padding: 15px;">Phone:</label>
					<form:input path="userCommDTO.phone" />
				</p>
				<br>
